...
/* harmony import */ var _mocked_cpu_intensive_external_worker__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./mocked-cpu-intensive-external.worker */ "./src/worker/app-workers/mocked-cpu-intensive-external.worker.ts");
/* harmony import */ var _shared_worker_message_model__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./shared/worker-message.model */ "./src/worker/app-workers/shared/worker-message.model.ts");
/* harmony import */ var _shared_worker_topic_constants__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./shared/worker-topic.constants */ "./src/worker/app-workers/shared/worker-topic.constants.ts");
...
var AppWorkers = /** @class */ (function () {
    ...
    AppWorkers.prototype.workerBroker = function ($event) {
        ...
        var workerMessage = new _shared_worker_message_model__WEBPACK_IMPORTED_MODULE_2__["WorkerMessage"](topic, data);
        switch (topic) {
            case _shared_worker_topic_constants__WEBPACK_IMPORTED_MODULE_3__["WORKER_TOPIC"].cpuIntensive:
                ...
                break;
            case _shared_worker_topic_constants__WEBPACK_IMPORTED_MODULE_3__["WORKER_TOPIC"].cpuIntensiveExternal:
                this.returnWorkResults(_mocked_cpu_intensive_external_worker__WEBPACK_IMPORTED_MODULE_1__["MockedCpuIntensiveWorkerExternal"].doWork(workerMessage));
                break;
...
/***/ "./src/worker/app-workers/mocked-cpu-intensive-external.worker.ts":
/*!************************************************************************!*\
  !*** ./src/worker/app-workers/mocked-cpu-intensive-external.worker.ts ***!
  \************************************************************************/
/*! exports provided: MockedCpuIntensiveWorkerExternal */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MockedCpuIntensiveWorkerExternal", function() { return MockedCpuIntensiveWorkerExternal; });
...
var MockedCpuIntensiveWorkerExternal = /** @class */ (function () {
    function MockedCpuIntensiveWorkerExternal() {
    }
    MockedCpuIntensiveWorkerExternal.doWork = function (value) {
        console.log('worker message', value);
        var before = moment__WEBPACK_IMPORTED_MODULE_0__();
        var count = 0;
        while (true) {
            count++;
        ...
        return new _shared_worker_message_model__WEBPACK_IMPORTED_MODULE_1__["WorkerMessage"](value.topic, { iteration: count });
    };
    return MockedCpuIntensiveWorkerExternal;
}());
...
var MockedCpuIntensiveWorker = /** @class */ (function () {
    function MockedCpuIntensiveWorker() {
    }
    MockedCpuIntensiveWorker.doWork = function (value) {
        var before = new Date();
        var count = 0;
        while (true) {
            count++;
        ...
        return new _shared_worker_message_model__WEBPACK_IMPORTED_MODULE_0__["WorkerMessage"](value.topic, { iteration: count });
    };
    return MockedCpuIntensiveWorker;
}());
